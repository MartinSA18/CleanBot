...
void setup()
{
  ...
  nh.subscribe(water_dispenser_sub);
...
/*******************************************************************************
* Callback function for water pump control
*******************************************************************************/

void waterPumpControl(const std_msgs::Float32& pumpVoltage_msg) {

  int pumpWriteVal = round(pumpVoltage_msg.data*68.9);
  ...
  //transformation volt to steps: 68.9
  analogWrite(pumpPin, pumpWriteVal);
}
